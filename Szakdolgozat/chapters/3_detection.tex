...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		sub&Vec3&\parbox{2.7cm}{\centering 2 térbeli pont\\(A,B)}&\parbox[c][1.5cm][c]{4.3cm}{\centering Visszaadja a két pont különbségét.}\\ \hline
		
		cross&Vec3&\parbox{2.7cm}{\centering 2 térbeli pont\\(A,B)}&\parbox[c][1.5cm][c]{4.3cm}{\centering Visszaadja a két pont Descartes szorzatát.}\\ \hline
		
		dot&Float&\parbox{2.7cm}{\centering 2 térbeli pont\\(A,B)}&\parbox[c][3cm][c]{4.3cm}{\centering Visszaadja a 2 pont koordinátáinak szorzatát\\(A.x * B.x + A.y * B.y + A.z * B.z)}\\ \hline
		
		getmin&Float&\parbox{2.7cm}{\centering 3 float változó\\(a,b,c)}&\parbox[c][1.5cm][c]{4.3cm}{\centering Visszaadja a 3 változó közül a legkisebbet.}\\ \hline
		
		getmax&Float&\parbox{2.7cm}{\centering 3 float változó\\(a,b,c)}&\parbox[c][1.5cm][c]{4.3cm}{\centering Visszaadja a 3 változó közül a legnagyobbat.}\\ \hline
		
		get\_distance&Float&\parbox{2.7cm}{\centering 2 térbeli pont\\(A,B)}&\parbox[c][1.5cm][c]{4.3cm}{\centering Visszaadja a 2 pont közötti távolságot.}\\ \hline	
