...
A \textbf{scale\_model} függvény 4 bemenettel rendelkezik, az első a modell maga, a maradék 3 pedig a méretezéshez szükséges float változók. A függvény végigmegy minden egyes háromszögén a modellnek, és a háromszög csúcspontjainak a koordinátáit megszorozza a megadott új méretekkel.
\newpage
...
\includegraphics[width=13truecm, height=7truecm]{images/modell_4.3.1.2.png}\\
...
\includegraphics[width=13truecm, height=7truecm]{images/modell_4.3.2.2.png}\\
$$\big\Downarrow$$
